...
def Tree_comparison(input_directory,input_d_tree,path_result):
    ...
    caract_model=pd.read_csv(input_directory+"Caracteristic_Models.csv",delimiter=";")
...
def Tree_model_watershed(input_directory,input_directory2,input_directory3,path_result):
    list_pheno=["Store_Phenom","Flux_Phenom"] #
