...
def Corr_properties_WTS(input_directory,input_d_2,path_result):
    ...
    convertname=pd.read_csv(input_directory+"CAMELS_Data/Conversion_name_camels_attributes.txt",sep=";")
    ...
    for line_file_properties in properties_file:
        Pro_data=pd.read_csv(input_directory+'CAMELS_Data/'+line_file_properties+".txt",delimiter=";")
