...
def Check_Phase_one():
    ...
    if not os.path.isfile(path_input +"ARCGIS/Distance_Knoben_HPD.csv"):
        print("P1 - The file 'Distance_Knoben_HPD.csv' is missing")
    if not os.path.isfile(path_input +"ARCGIS/Compa_Eco_HPD.csv"):
...
def Check_Phase_three():
    path_input=os.path.dirname(os.getcwd())+'/Input/'
    if not os.path.isfile(path_input +"Model_Data/Caracteristic_Models.csv"):
